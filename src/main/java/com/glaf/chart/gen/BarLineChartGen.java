...
public class BarLineChartGen implements ChartGen {
	protected static final Log logger = LogFactory.getLog(BarLineChartGen.class);

	public static void main(String[] paramArrayOfString) {
		BarLineChartGen chartDemo = new BarLineChartGen();
		...
		chartModel.setChartName("bar_line");
		chartModel.setChartType("bar_line");
	...
	public JFreeChart createChart(Chart chartModel) {
		logger.debug("------------BarLineChartGen.createChart-----------------");
