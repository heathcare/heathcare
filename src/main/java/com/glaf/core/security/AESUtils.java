...
public class AESUtils {
	 ...
	 * @throws Exception
	 */
	public static byte[] decryptECB(String ikey, byte[] data) throws Exception {
		SecretKey secretKey = getKeySpec(ikey);
	 ...
	 * @throws Exception
	 */
	public static byte[] encryptECB(String ikey, byte[] data) throws Exception {
		SecretKey secretKey = getKeySpec(ikey);
		Cipher cipher = Cipher.getInstance(ECB_CIPHER_ALGORITHM);
		cipher.init(Cipher.ENCRYPT_MODE, secretKey);// 初始化
		return cipher.doFinal(data);// 加密
