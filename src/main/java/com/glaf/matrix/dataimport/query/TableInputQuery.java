...
public class TableInputQuery extends BaseQuery {
	...
	public TableInputQuery() {

	}

	public TableInputQuery attachmentFlag(String attachmentFlag) {
	...
	public TableInputQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public TableInputQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public TableInputQuery descriptionLike(String descriptionLike) {
	...
	public TableInputQuery nodeId(Long nodeId) {
		if (nodeId == null) {
	...
	public TableInputQuery privilegeFlag(String privilegeFlag) {
	...
	public TableInputQuery revision(Integer revision) {
		if (revision == null) {
	...
	public TableInputQuery systemFlag(String systemFlag) {
		if (systemFlag == null) {
	...
	public TableInputQuery tableIds(List<String> tableIds) {
		if (tableIds == null) {
	...
	public TableInputQuery titleLike(String titleLike) {
		if (titleLike == null) {
	...
	public TableInputQuery type(String type) {
		if (type == null) {
