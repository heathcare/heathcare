...
package com.glaf.matrix.dataimport.query;

import java.util.List;

import com.glaf.core.query.BaseQuery;

public class TableInputColumnQuery extends BaseQuery {
	...
	public TableInputColumnQuery() {

	}

	public TableInputColumnQuery columnName(String columnName) {
		if (columnName == null) {
	...
	public TableInputColumnQuery columnNameLike(String columnNameLike) {
	...
	public TableInputColumnQuery columnNames(List<String> columnNames) {
		if (columnNames == null) {
	...
	public TableInputColumnQuery discriminator(String discriminator) {
	...
	public TableInputColumnQuery name(String name) {
		if (name == null) {
	...
	public TableInputColumnQuery namedColumnSetId(String namedColumnSetId) {
	...
	public TableInputColumnQuery namedColumnSetIdLike(String namedColumnSetIdLike) {
	...
	public TableInputColumnQuery namedColumnSetIds(List<String> namedColumnSetIds) {
	...
	public TableInputColumnQuery nameLike(String nameLike) {
		if (nameLike == null) {
			throw new RuntimeException("name is null");
		}
	...
	public TableInputColumnQuery tableId(String tableId) {
		if (tableId == null) {
	...
	public TableInputColumnQuery tableName(String tableName) {
		if (tableName == null) {
	...
	public TableInputColumnQuery tableNameLike(String tableNameLike) {
	...
	public TableInputColumnQuery tableNames(List<String> tableNames) {
		if (tableNames == null) {
	...
	public TableInputColumnQuery targetId(String targetId) {
		if (targetId == null) {
	...
	public TableInputColumnQuery titleLike(String titleLike) {
		if (titleLike == null) {
