...
public interface TableInputMapper {
	...
	void deleteTableInputById(String tableId);

	void deleteTableInputs(TableInputQuery query);
	...
	List<TableInput> getTableInputColumns(TableInputQuery query);

	void insertTableInput(TableInput model);

	void updateTableInput(TableInput model);
