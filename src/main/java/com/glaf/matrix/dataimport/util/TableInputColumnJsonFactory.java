...
public class TableInputColumnJsonFactory {

	public static java.util.List<TableInputColumn> arrayToList(JSONArray array) {
		java.util.List<TableInputColumn> list = new java.util.ArrayList<TableInputColumn>();
		for (int i = 0, len = array.size(); i < len; i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			TableInputColumn model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}

	public static TableInputColumn jsonToObject(JSONObject jsonObject) {
		TableInputColumn model = new TableInputColumn();
	...
	public static JSONArray listToArray(java.util.List<TableInputColumn> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (TableInputColumn model : list) {
	...
	public static JSONObject toJsonObject(TableInputColumn model) {
	...
	public static ObjectNode toObjectNode(TableInputColumn model) {
	...
	private TableInputColumnJsonFactory() {
