...
package com.glaf.modules.dictory.mapper;
...
@Component("com.glaf.modules.dictory.mapper.DictoryMapper")
public interface DictoryMapper {
	...
	List<Dictory> getDictoryListByCategory( DictoryQuery query);
