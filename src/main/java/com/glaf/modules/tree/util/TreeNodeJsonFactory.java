...
package com.glaf.modules.tree.util;
...
public class TreeNodeJsonFactory {

	public static java.util.List<TreeNode> arrayToList(JSONArray array) {
		java.util.List<TreeNode> list = new java.util.ArrayList<TreeNode>();
		for (int i = 0; i < array.size(); i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			TreeNode model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}

	public static TreeNode jsonToObject(JSONObject jsonObject) {
	...
	public static JSONArray listToArray(java.util.List<TreeNode> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (TreeNode model : list) {
	...
	public static JSONObject toJsonObject(TreeNode model) {
	...
	public static ObjectNode toObjectNode(TreeNode model) {
