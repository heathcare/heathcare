...
package com.glaf.modules.tree.model;
...
public class TreeNode implements Serializable, TreeModel, JSONable {
	...
	public TreeNode jsonToObject(JSONObject jsonObject) {
		return TreeNodeJsonFactory.jsonToObject(jsonObject);
	}
	...
	public JSONObject toJsonObject() {
		return TreeNodeJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return TreeNodeJsonFactory.toObjectNode(this);
	}
