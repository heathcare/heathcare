...
package com.glaf.modules.tree.query;

import java.util.List;

import com.glaf.core.query.DataQuery;

public class TreeNodeQuery extends DataQuery {
	...
	public TreeNodeQuery code(String code) {
		if (code == null) {
	...
	public TreeNodeQuery codeLike(String codeLike) {
		if (codeLike == null) {
			throw new RuntimeException("code is null");
		}
	...
	public TreeNodeQuery codes(List<String> codes) {
		if (codes == null) {
	...
	public TreeNodeQuery descLike(String descLike) {
		if (descLike == null) {
	...
	public TreeNodeQuery locked(Integer locked) {
		if (locked == null) {
	...
	public TreeNodeQuery name(String name) {
		if (name == null) {
	...
	public TreeNodeQuery nameLike(String nameLike) {
		if (nameLike == null) {
			throw new RuntimeException("name is null");
		}
	...
	public TreeNodeQuery names(List<String> names) {
		if (names == null) {
	...
	public TreeNodeQuery nodeIds(List<Long> nodeIds) {
		if (nodeIds == null) {
	...
	public TreeNodeQuery sortGreaterThanOrEqual(Integer sortGreaterThanOrEqual) {
	...
	public TreeNodeQuery sortLessThanOrEqual(Integer sortLessThanOrEqual) {
	...
	public TreeNodeQuery urlLike(String urlLike) {
		if (urlLike == null) {
