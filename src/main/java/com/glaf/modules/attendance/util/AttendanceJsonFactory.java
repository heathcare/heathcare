 ...
 *
 */
public class AttendanceJsonFactory {

	public static Attendance jsonToObject(JSONObject jsonObject) {
	...
	public static JSONObject toJsonObject(Attendance model) {
	...
	public static ObjectNode toObjectNode(Attendance model) {
	...
	public static JSONArray listToArray(java.util.List<Attendance> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (Attendance model : list) {
	...
	public static java.util.List<Attendance> arrayToList(JSONArray array) {
		java.util.List<Attendance> list = new java.util.ArrayList<Attendance>();
		for (int i = 0, len = array.size(); i < len; i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			Attendance model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}

	private AttendanceJsonFactory() {
