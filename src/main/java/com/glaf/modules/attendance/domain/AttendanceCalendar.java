...
@Entity
@Table(name = "T_ATTENDANCE_CALENDAR")
public class AttendanceCalendar implements Serializable, JSONable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AttendanceCalendar other = (AttendanceCalendar) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public AttendanceCalendar jsonToObject(JSONObject jsonObject) {
		return AttendanceCalendarJsonFactory.jsonToObject(jsonObject);
	}

	public JSONObject toJsonObject() {
		return AttendanceCalendarJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return AttendanceCalendarJsonFactory.toObjectNode(this);
	}
