...
public class AttendanceCalendarQuery extends DataQuery {
	...
	public AttendanceCalendarQuery() {
	...
	public AttendanceCalendarQuery tenantId(String tenantId) {
		if (tenantId == null) {
	...
	public AttendanceCalendarQuery tenantIds(List<String> tenantIds) {
		if (tenantIds == null) {
	...
	public AttendanceCalendarQuery type(String type) {
		if (type == null) {
	...
	public AttendanceCalendarQuery types(List<String> types) {
		if (types == null) {
	...
	public AttendanceCalendarQuery year(Integer year) {
		if (year == null) {
	...
	public AttendanceCalendarQuery yearGreaterThanOrEqual(Integer yearGreaterThanOrEqual) {
	...
	public AttendanceCalendarQuery yearLessThanOrEqual(Integer yearLessThanOrEqual) {
	...
	public AttendanceCalendarQuery years(List<Integer> years) {
		if (years == null) {
	...
	public AttendanceCalendarQuery month(Integer month) {
		if (month == null) {
	...
	public AttendanceCalendarQuery monthGreaterThanOrEqual(Integer monthGreaterThanOrEqual) {
	...
	public AttendanceCalendarQuery monthLessThanOrEqual(Integer monthLessThanOrEqual) {
	...
	public AttendanceCalendarQuery months(List<Integer> months) {
		if (months == null) {
	...
	public AttendanceCalendarQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public AttendanceCalendarQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
