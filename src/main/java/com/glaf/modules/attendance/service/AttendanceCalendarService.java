...
public interface AttendanceCalendarService {
	...
	@Transactional
	void bulkInsert(List<AttendanceCalendar> list);
	 ...
	 * @return
	 */
	List<AttendanceCalendar> list(AttendanceCalendarQuery query);
	 ...
	 * @return
	 */
	int getAttendanceCalendarCountByQueryCriteria(AttendanceCalendarQuery query);
	 ...
	 * @return
	 */
	List<AttendanceCalendar> getAttendanceCalendarsByQueryCriteria(int start, int pageSize,
