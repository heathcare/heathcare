...
public class PinyinUtils {
	...
	public static void processDishes() {
		...
		try {
			...
			tableDefinition.setTableName("HEALTH_DISHES");
			...
			String sql = " select ID_, NAME_ from HEALTH_DISHES ";
			...
			psmt = conn.prepareStatement(" update HEALTH_DISHES set NAMEPINYIN_ = ? where ID_ = ? ");
	...
	public static void processEmployee() {
		...
		try {
			...
			conn.setAutoCommit(false);
			TableDefinition tableDefinition = new TableDefinition();
			tableDefinition.setTableName("T_EMPLOYEE");
			...
			String sql = " select ID_, NAME_ from T_EMPLOYEE ";
			psmt = conn.prepareStatement(sql);
			rs = psmt.executeQuery();
			while (rs.next()) {
			...
			psmt = conn.prepareStatement(" update T_EMPLOYEE set NAMEPINYIN_ = ? where ID_ = ? ");
