...
public class GoodsActualQuantityDomainFactory {
	...
	static {
		...
		columnMap.put("nodeSort", "NODESORT_");
		...
		javaTypeMap.put("nodeSort", "Integer");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		ColumnDefinition nodeSort = new ColumnDefinition();
        nodeSort.setName("nodeSort");
        nodeSort.setColumnName("NODESORT_");
        nodeSort.setJavaType("Integer");
        tableDefinition.addColumn(nodeSort);
