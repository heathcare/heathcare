...
public class PersonTransferSchoolDomainFactory {
	...
	static {
		...
		columnMap.put("leaveDate", "LEAVEDATE_");
		...
		javaTypeMap.put("leaveDate", "Date");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		ColumnDefinition leaveDate = new ColumnDefinition();
		leaveDate.setName("leaveDate");
		leaveDate.setColumnName("LEAVEDATE_");
		leaveDate.setJavaType("Date");
		tableDefinition.addColumn(leaveDate);
