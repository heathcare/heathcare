 ...
 *
 */
public class GradePersonRelationDomainFactory {

	public static final String TABLENAME = "HEALTH_GRADE_PERSON_RELATION";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("GradePersonRelation");
	...
	private GradePersonRelationDomainFactory() {
