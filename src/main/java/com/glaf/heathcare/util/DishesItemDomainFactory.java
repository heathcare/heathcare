 ...
 *
 */
public class DishesItemDomainFactory {

	public static final String TABLENAME = "HEALTH_DISHES_ITEM";
	...
	static {
		...
		columnMap.put("dishesId", "DISHESID_");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("DishesItem");
		...
		ColumnDefinition dishesId = new ColumnDefinition();
		dishesId.setName("dishesId");
		dishesId.setColumnName("DISHESID_");
		dishesId.setJavaType("Long");
		tableDefinition.addColumn(dishesId);
	...
	private DishesItemDomainFactory() {
