...
public class PersonTransferSchoolJsonFactory {
	...
	public static PersonTransferSchool jsonToObject(JSONObject jsonObject) {
		...
		if (jsonObject.containsKey("leaveDate")) {
			model.setLeaveDate(jsonObject.getDate("leaveDate"));
		}
	...
	public static JSONObject toJsonObject(PersonTransferSchool model) {
		...
		if (model.getLeaveDate() != null) {
			jsonObject.put("leaveDate", DateUtils.getDate(model.getLeaveDate()));
			jsonObject.put("leaveDate_date", DateUtils.getDate(model.getLeaveDate()));
			jsonObject.put("leaveDate_datetime", DateUtils.getDateTime(model.getLeaveDate()));
		}
