...
public class PersonDomainFactory {
	...
	static {
		...
		columnMap.put("oneChild", "ONECHILD_");
		columnMap.put("disability", "DISABILITY_");
		columnMap.put("guardian", "GUARDIAN_");
		columnMap.put("guardianCardType", "GUARDIANCARDTYPE_");
		columnMap.put("guardianNo", "GUARDIANNO_");
		...
		javaTypeMap.put("oneChild", "String");
		javaTypeMap.put("disability", "String");
		javaTypeMap.put("guardian", "String");
		javaTypeMap.put("guardianCardType", "String");
		javaTypeMap.put("guardianNo", "String");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		bloodType.setColumnName("BLOODTYPE_");
		bloodType.setJavaType("String");
		bloodType.setLength(20);
		tableDefinition.addColumn(bloodType);
		...
		natureType.setLength(20);
		tableDefinition.addColumn(natureType);

		ColumnDefinition oneChild = new ColumnDefinition();
		oneChild.setName("oneChild");
		oneChild.setColumnName("ONECHILD_");
		oneChild.setJavaType("String");
		oneChild.setLength(20);
		tableDefinition.addColumn(oneChild);

		ColumnDefinition disability = new ColumnDefinition();
		disability.setName("disability");
		disability.setColumnName("DISABILITY_");
		disability.setJavaType("String");
		disability.setLength(20);
		tableDefinition.addColumn(disability);

		ColumnDefinition guardian = new ColumnDefinition();
		guardian.setName("guardian");
		guardian.setColumnName("GUARDIAN_");
		guardian.setJavaType("String");
		guardian.setLength(50);
		tableDefinition.addColumn(guardian);

		ColumnDefinition guardianCardType = new ColumnDefinition();
		guardianCardType.setName("guardianCardType");
		guardianCardType.setColumnName("GUARDIANCARDTYPE_");
		guardianCardType.setJavaType("String");
		guardianCardType.setLength(50);
		tableDefinition.addColumn(guardianCardType);

		ColumnDefinition guardianNo = new ColumnDefinition();
		guardianNo.setName("guardianNo");
		guardianNo.setColumnName("GUARDIANNO_");
		guardianNo.setJavaType("String");
		guardianNo.setLength(50);
		tableDefinition.addColumn(guardianNo);
