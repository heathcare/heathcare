 ...
 *
 */
public class DietaryTemplateCountDomainFactory {

	public static final String TABLENAME = "HEALTH_DIETARY_TPL_COUNT";
	 ...
	 * @param cnt
	 */
	public static void copyProperties(DietaryTemplateCount dietary, CompositionCount cnt) {
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("DietaryTemplateCount");
	...
	private DietaryTemplateCountDomainFactory() {
