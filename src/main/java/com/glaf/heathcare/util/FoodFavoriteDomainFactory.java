 ...
 *
 */
public class FoodFavoriteDomainFactory {

	public static final String TABLENAME = "HEALTH_FOOD_FAVORITE";
	...
	static {
		...
		columnMap.put("subNodeId", "SUBNODEID_");
		...
		javaTypeMap.put("subNodeId", "Long");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("FoodFavorite");
		...
		ColumnDefinition subNodeId = new ColumnDefinition();
		subNodeId.setName("subNodeId");
		subNodeId.setColumnName("SUBNODEID_");
		subNodeId.setJavaType("Long");
		tableDefinition.addColumn(subNodeId);
	...
	private FoodFavoriteDomainFactory() {
