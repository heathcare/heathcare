 ...
 *
 */
public class DietaryTemplateCountJsonFactory {

	public static java.util.List<DietaryTemplateCount> arrayToList(JSONArray array) {
		java.util.List<DietaryTemplateCount> list = new java.util.ArrayList<DietaryTemplateCount>();
		for (int i = 0, len = array.size(); i < len; i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			DietaryTemplateCount model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}

	public static DietaryTemplateCount jsonToObject(JSONObject jsonObject) {
	...
	public static JSONArray listToArray(java.util.List<DietaryTemplateCount> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (DietaryTemplateCount model : list) {
	...
	public static JSONObject toJsonObject(DietaryTemplateCount model) {
	...
	public static ObjectNode toObjectNode(DietaryTemplateCount model) {
	...
	private DietaryTemplateCountJsonFactory() {
