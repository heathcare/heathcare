...
public class PersonJsonFactory {
	...
	public static Person jsonToObject(JSONObject jsonObject) {
		...
		if (jsonObject.containsKey("oneChild")) {
			model.setOneChild(jsonObject.getString("oneChild"));
		}
		if (jsonObject.containsKey("disability")) {
			model.setDisability(jsonObject.getString("disability"));
		}
		if (jsonObject.containsKey("guardian")) {
			model.setGuardian(jsonObject.getString("guardian"));
		}
		if (jsonObject.containsKey("guardianCardType")) {
			model.setGuardianCardType(jsonObject.getString("guardianCardType"));
		}
		if (jsonObject.containsKey("guardianNo")) {
			model.setGuardianNo(jsonObject.getString("guardianNo"));
		}
	...
	public static JSONObject toJsonObject(Person model) {
		...
		if (model.getOneChild() != null) {
			jsonObject.put("oneChild", model.getOneChild());
		}
		if (model.getDisability() != null) {
			jsonObject.put("disability", model.getDisability());
		}
		if (model.getGuardian() != null) {
			jsonObject.put("guardian", model.getGuardian());
		}
		if (model.getGuardianCardType() != null) {
			jsonObject.put("guardianCardType", model.getGuardianCardType());
		}
		if (model.getGuardianNo() != null) {
			jsonObject.put("guardianNo", model.getGuardianNo());
		}
