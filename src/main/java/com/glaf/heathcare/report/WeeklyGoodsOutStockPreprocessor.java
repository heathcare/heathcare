...
public class WeeklyGoodsOutStockPreprocessor implements IReportPreprocessor {
	...
	public void prepare(Tenant tenant, int year, int month, Map<String, Object> params) {
		...
		if (startDate != null && endDate != null) {
			...
			sqlBuffer.append(
					" select E.GOODSID_ as goodsid, E.QUANTITY_ as quantity, E.TOTALPRICE_ as totalprice, E.OUTSTOCKTIME_ as outstocktime from GOODS_OUT_STOCK")
					...
					.append(" ) and ( E.BUSINESSSTATUS_ = 9 ) and E.OUTSTOCKTIME_ is not null ")
			...
			List<GoodsOutStock> rows = new ArrayList<GoodsOutStock>();
			if (list != null && !list.isEmpty()) {
				...
				for (Map<String, Object> dataMap : list) {
					...
					m.setOutStockTime(ParamUtils.getDate(dataMap, "outstocktime"));
			...
			if (!rows.isEmpty()) {
				...
				List<GoodsOutStock> rows1 = new ArrayList<GoodsOutStock>();
				List<GoodsOutStock> rows2 = new ArrayList<GoodsOutStock>();
				List<GoodsOutStock> rows3 = new ArrayList<GoodsOutStock>();
				List<GoodsOutStock> rows4 = new ArrayList<GoodsOutStock>();
				List<GoodsOutStock> rows5 = new ArrayList<GoodsOutStock>();
				...
				for (GoodsOutStock m : rows) {
					...
					calendar.setTime(m.getOutStockTime());
					...
					case Calendar.MONDAY:
						...
						if (day1 == null) {
							day1 = DateUtils.getDate(m.getOutStockTime());
						}
					...
					case Calendar.TUESDAY:
						...
						if (day2 == null) {
							day2 = DateUtils.getDate(m.getOutStockTime());
						}
					...
					case Calendar.WEDNESDAY:
						...
						if (day3 == null) {
							day3 = DateUtils.getDate(m.getOutStockTime());
						}
					...
					case Calendar.THURSDAY:
						...
						if (day4 == null) {
							day4 = DateUtils.getDate(m.getOutStockTime());
						}
					...
					case Calendar.FRIDAY:
						...
						if (day5 == null) {
							day5 = DateUtils.getDate(m.getOutStockTime());
						}
