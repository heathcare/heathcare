...
public class WeeklyGoodsInStockPreprocessor implements IReportPreprocessor {
	protected static final Log logger = LogFactory.getLog(WeeklyGoodsInStockPreprocessor.class);
	...
	public void prepare(Tenant tenant, int year, int month, Map<String, Object> params) {
		...
		if (startDate != null && endDate != null) {
			...
			sqlBuffer.append(
					" select E.GOODSID_ as goodsid, E.QUANTITY_ as quantity, E.PRICE_ as price, E.TOTALPRICE_ as totalprice, E.INSTOCKTIME_ as instocktime from GOODS_IN_STOCK")
			...
			if (list != null && !list.isEmpty()) {
				...
				for (Map<String, Object> dataMap : list) {
					...
					// logger.debug(m.getGoodsName() + "\t" + m.getPrice() + "\t" +
					// m.getTotalPrice());
				}
			}
