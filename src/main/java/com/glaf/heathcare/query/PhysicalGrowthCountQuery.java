...
public class PhysicalGrowthCountQuery extends DataQuery {
	...
	public PhysicalGrowthCountQuery month(Integer month) {
		if (month == null) {
	...
	public PhysicalGrowthCountQuery standard(String standard) {
		if (standard == null) {
	...
	public PhysicalGrowthCountQuery type(String type) {
		if (type == null) {
	...
	public PhysicalGrowthCountQuery year(Integer year) {
		if (year == null) {
