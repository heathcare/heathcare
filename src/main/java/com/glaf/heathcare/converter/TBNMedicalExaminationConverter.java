...
public class TBNMedicalExaminationConverter {
	protected final static Log logger = LogFactory.getLog(TBNMedicalExaminationConverter.class);

	public List<MedicalExamination> getMedicalExaminations(java.io.InputStream inputStream) {
		logger.debug("----------------TBNMedicalExaminationConverter------------------");
