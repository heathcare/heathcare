...
public class HaizgMedicalJoinExaminationConverter {
	protected final static Log logger = LogFactory.getLog(HaizgMedicalJoinExaminationConverter.class);

	public List<MedicalExamination> getMedicalExaminations(java.io.InputStream inputStream) {
		logger.debug("----------------HaizgMedicalJoinExaminationConverter------------------");
