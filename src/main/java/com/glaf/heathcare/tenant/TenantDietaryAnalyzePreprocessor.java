		...
		if (startDate != null && endDate != null) {
			...
			if (rows != null && !rows.isEmpty()) {
				...
				if (totalPerson > 0) {
					...
					fat = fat / (totalPerson);
					protein = protein / (totalPerson);
					carbohydrate = carbohydrate / (totalPerson);

					FoodComposition avg = new FoodComposition();
					avg.setQuantity(total.getQuantity() / (totalPerson));
					avg.setHeatEnergy(totalPersonHE);
					avg.setFat(fat);
					avg.setProtein(protein);
					avg.setCarbohydrate(carbohydrate);
					avg.setVitaminA(total.getVitaminA() / (totalPerson));
					avg.setVitaminB1(total.getVitaminB1() / (totalPerson));
					avg.setVitaminB2(total.getVitaminB2() / (totalPerson));
					avg.setVitaminB6(total.getVitaminB6() / (totalPerson));
					avg.setVitaminB12(total.getVitaminB12() / (totalPerson));
					avg.setVitaminC(total.getVitaminC() / (totalPerson));
					avg.setVitaminE(total.getVitaminE() / (totalPerson));
					avg.setNicotinicCid(total.getNicotinicCid() / (totalPerson));
					avg.setRetinol(total.getRetinol() / (totalPerson));
					avg.setCalcium(total.getCalcium() / (totalPerson));
					avg.setIron(total.getIron() / (totalPerson));
					avg.setZinc(total.getZinc() / (totalPerson));
					avg.setIodine(total.getIodine() / (totalPerson));
					avg.setPhosphorus(total.getPhosphorus() / (totalPerson));
					...
					beansProtein = beansProtein * 1000 / (totalPerson);
					animalsProtein = animalsProtein * 1000 / (totalPerson);
