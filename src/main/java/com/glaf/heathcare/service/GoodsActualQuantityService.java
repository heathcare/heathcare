...
public interface GoodsActualQuantityService {
	 ...
	 */
	@Transactional
	void copyInStock(String tenantId, int fullDay, String userId, boolean includePlan);
	 ...
	 */
	@Transactional
	void copyPlan(String tenantId, int fullDay, String userId);
	...
	List<WeeklyFee> getGoodsWeeklyFeeByTenantId(String tenantId, int year, int month);
