...
public interface MedicalSpotCheckService {
	 ...
	 * @return
	 */
	int getMedicalSpotCheckCountByQueryCriteria(MedicalSpotCheckQuery query);
	 ...
	 * @return
	 */
	List<MedicalSpotCheck> getMedicalSpotChecksByQueryCriteria(int start, int pageSize, MedicalSpotCheckQuery query);
