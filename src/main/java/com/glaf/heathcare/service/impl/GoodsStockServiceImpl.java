...
public class GoodsStockServiceImpl implements GoodsStockService {
	...
	public GoodsStock getGoodsStockByGoodsId(String tenantId, long goodsId) {
		if (tenantId == null || goodsId == 0) {
			return null;
		}
	...
	public void inStock(GoodsStock goodsStock) {
		...
		GoodsStock model = this.getGoodsStockByGoodsId(goodsStock.getTenantId(), goodsStock.getGoodsId());
		if (model == null) {
