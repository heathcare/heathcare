...
public class GoodsOutStockServiceImpl implements GoodsOutStockService {
	...
	@Transactional
	public void cancelAudit(GoodsOutStock goodsOutStock) {
		...
		if (goodsOutStock.getBusinessStatus() == 9) {
			...
			goodsStockService.inStock(goodsStock);// 还回库存

			goodsOutStock.setBusinessStatus(0);
			goodsOutStock.setConfirmTime(null);
			goodsOutStock.setConfirmBy(null);
			goodsOutStockMapper.updateGoodsOutStockStatus(goodsOutStock);// 取消出库状态
		}
	}
