...
public class PhysicalGrowthCountServiceImpl implements PhysicalGrowthCountService {
	...
	@Transactional
	public void bulkInsert(Collection<PhysicalGrowthCount> list) {
	...
	@Transactional
	public void saveAll(String tenantId, String type, int year, int month, Collection<PhysicalGrowthCount> rows) {
		PhysicalGrowthCountQuery query = new PhysicalGrowthCountQuery();
		query.tenantId(tenantId);
		query.type(type);
		query.year(year);
		query.month(month);
		physicalGrowthCountMapper.deletePhysicalGrowthCount(query);
