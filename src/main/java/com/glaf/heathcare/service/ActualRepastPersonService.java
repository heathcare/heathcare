...
public interface ActualRepastPersonService {

	@Transactional
	void bulkInsert(List<ActualRepastPerson> list);
	 ...
	 * @return
	 */
	ActualRepastPerson getActualRepastPerson(String id);
	 ...
	 * @return
	 */
	List<ActualRepastPerson> getActualRepastPersonsByQueryCriteria(int start, int pageSize,
	 ...
	 * @return
	 */
	List<ActualRepastPerson> list(ActualRepastPersonQuery query);
