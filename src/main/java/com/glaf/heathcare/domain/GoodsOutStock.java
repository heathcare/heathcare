...
@Entity
@Table(name = "GOODS_OUT_STOCK")
public class GoodsOutStock implements Serializable, JSONable {
	...
	@Column(name = "OUTSTOCKTIME_")
	protected Date outStockTime;

	@javax.persistence.Transient
	protected String outStockTimeString;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		GoodsOutStock other = (GoodsOutStock) obj;
		if (id != other.id)
			return false;
		return true;
	}
	...
	public String getOutStockTimeString() {
		if (this.outStockTime != null) {
			return DateUtils.getDateTime(this.outStockTime);
		}
		return "";
	}
	...
	public GoodsOutStock jsonToObject(JSONObject jsonObject) {
		return GoodsOutStockJsonFactory.jsonToObject(jsonObject);
	}
	...
	public JSONObject toJsonObject() {
		return GoodsOutStockJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return GoodsOutStockJsonFactory.toObjectNode(this);
	}
