...
public class MedicalExamination implements Serializable, JSONable, IMedicalEvaluate {
	...
	public String getAlt() {
		if ("1".equals(sex)) {
			if (altValue > 40.0) {
				alt = "偏高";
			} else if (altValue > 0 && altValue <= 40.0) {
				alt = "正常";
			} else if (altValue == 0) {
				alt = "";
			}
	...
	public String getAltHtml() {
		altHtml = "<span style='color:#339933; font:bold 12px 微软雅黑;'>正常</span>";
		if ("1".equals(sex)) {
			if (altValue > 40.0) {
				altHtml = "<span style='color:#ff0000; font:bold 12px 微软雅黑;'>偏高</span>";
			} else if (altValue > 0 && altValue <= 40.0) {
				altHtml = "<span style='color:#339933; font:bold 12px 微软雅黑;'>正常</span>";
			} else if (altValue == 0) {
				altHtml = "";
	...
	public int getAnemiaLevel() {
		...
		if (hemoglobinValue >= 90.0 && hemoglobinValue < 110.0) {
			...
			anemiaLevel = -3;
		} else if (hemoglobinValue < 30.0 && hemoglobinValue > 0.0) {
			anemiaLevel = -4;
		}
		return anemiaLevel;
	}
	...
	public int getCheckIntervalMoon() {
		return checkIntervalMoon;
	}
	...
	public String getHemoglobinHtml() {
		hemoglobinHtml = "<span style='color:#339933; font:bold 12px 微软雅黑;'>正常</span>";
		if (hemoglobinValue >= 90.0 && hemoglobinValue < 110.0) {
			hemoglobinHtml = "<span style='color:#FF9966; font:bold 12px 微软雅黑;'>轻度贫血</span>";
		} else if (hemoglobinValue >= 60.0 && hemoglobinValue < 90.0) {
			hemoglobinHtml = "<span style='color:#FF6666; font:bold 12px 微软雅黑;'>中度贫血</span>";
		} else if (hemoglobinValue >= 30.0 && hemoglobinValue < 60.0) {
			hemoglobinHtml = "<span style='color:#FF0033; font:bold 12px 微软雅黑;'>重度贫血</span>";
		} else if (hemoglobinValue < 30.0 && hemoglobinValue > 0) {
			hemoglobinHtml = "<span style='color:#ff0000; font:bold 12px 微软雅黑;'>极重度贫血</span>";
	...
	public double getWeightIncrement() {
		if (weight > 0 && previousWeight > 0) {
			weightIncrement = weight - previousWeight;
		}
	...
	public void setAnemiaLevel(int anemiaLevel) {
	...
	public void setCheckIntervalMoon(int checkIntervalMoon) {
		this.checkIntervalMoon = checkIntervalMoon;
	}
	...
	public void setHemoglobinHtml(String hemoglobinHtml) {
		this.hemoglobinHtml = hemoglobinHtml;
	}
	...
	public void setMedicineFlag(int medicineFlag) {
