...
@Entity
@Table(name = "HEALTH_DIETARY_TPL_COUNT")
public class DietaryTemplateCount implements Serializable, JSONable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DietaryTemplateCount other = (DietaryTemplateCount) obj;
		if (id != other.id)
			return false;
		return true;
	}
	...
	public DietaryTemplateCount jsonToObject(JSONObject jsonObject) {
		return DietaryTemplateCountJsonFactory.jsonToObject(jsonObject);
	}
	...
	public JSONObject toJsonObject() {
		return DietaryTemplateCountJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return DietaryTemplateCountJsonFactory.toObjectNode(this);
	}
