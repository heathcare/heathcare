...
<script type="text/javascript">
	...
	function saveData(){
	    ...
	    if(confirm("确定将"+dateTime+"的入库单复制到出库单中吗？")){
		  var params = jQuery("#iForm").formSerialize();
		  jQuery.ajax({
				   type: "POST",
				   url: '${contextPath}/heathcare/goodsOutStock/copyInStock',
				   data: params,
				   dataType: 'json',
				   error: function(data){
					   alert('服务器处理错误！');
...
<div class="easyui-layout" data-options="fit:true">  
  <div data-options="region:'north',split:false,border:true" style="height:45px" class="toolbar-backgroud"> 
	...
	<img src="${contextPath}/static/images/window.png">&nbsp;<span class="x_content_title">复制入库单</span>
  ...
  <table class="easyui-form" style="width:450px;" align="center">
    <tbody>
	<tr>
		<td width="20%" align="left">入库日期</td>
