...
<script type="text/javascript">
	...
	function saveData(){
		...
		jQuery.ajax({
				   type: "POST",
				   url: '${contextPath}/heathcare/goodsOutStock/saveBatch',
				   data: params,
				   dataType:  'json',
				   error: function(data){
					   alert('服务器处理错误！');
...
<div class="easyui-layout" data-options="fit:true">  
  <div data-options="region:'north',split:false,border:true" style="height:45px;margin-top:0px;" class="toolbar-backgroud"> 
    <div style="margin:4px;"> 
	<img src="${contextPath}/static/images/window.png">&nbsp;<span class="x_content_title">出库信息</span>
  ...
  <table class="table-border" cellspacing="1" cellpadding="4" width="95%" nowrap align="center">
    <thead>
	  ...
	  <td class="table-head" width="20%" align="center">库存量(千克)</td>
	...
	<tr>
		<td width="40%" class="table-content" align="left"> ${plan.goodsName} </td>
		<td width="20%" class="table-content" align="right"> ${plan.quantity} </td>
		<td width="20%" class="table-content" align="right"> ${plan.stockQuantity} </td>
