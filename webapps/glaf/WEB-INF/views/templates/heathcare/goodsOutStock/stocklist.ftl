   ...
   jQuery(function(){
		jQuery('#mydatagrid').datagrid({
				...
				columns:[[
					...
					{title:'物品名称', field:'name', align:'left', width:350, formatter:formatterName, sortable:true},
					{title:'数量', field:'quantity', align:'right', width:120, sortable:true},
					{title:'计量单位', field:'unit', align:'center', width:120, formatter:formatterUnit},
					{title:'最近有效期', field:'expiryDate', align:'center', width:120, sortable:true},
					{title:'上次出库时间', field:'latestOutStockTime', align:'center', width:120, sortable:true},
				]],
				rownumbers: false,
				pagination: false
			});
