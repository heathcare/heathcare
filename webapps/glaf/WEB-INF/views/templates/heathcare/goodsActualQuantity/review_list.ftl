   ...
   jQuery(function(){
		jQuery('#mydatagrid').datagrid({
				...
				columns:[[
					...
					{title:'总价', field:'totalPrice', width:100, align:'right', sortable:true},
	...
	function doExport99(){
		...
		var link="${contextPath}/heathcare/tenantReportMain/exportXls?ts=${ts}&tenantId=${tenantId}&reportId=TenantDietaryStructAnalyze";
		if(startTime != ""){
			link = link + "&startDate=" + startTime;
		}
		if(endTime != ""){
       ...
       <tr valign="top">
		...
		<td valign="top" style="font-size:13px; line-height:20px;">
		  ...
		  <a href="#" class="easyui-linkbutton" data-options="plain:true, iconCls:'icon_export_xls'"
	         onclick="javascript:doExport99();">膳食调查分析表</a>
		</td>
       </tr>
      </table>
	</form>
