...
<script type="text/javascript">
    ...
    function getLink(){
	    var link_ = "${contextPath}/heathcare/goodsActualQuantity/reviewJson?tenantId=${tenantId}&startTime=${startTime}&endTime=${endTime}&avgQuantity=on";
		//alert(link_);
	    return link_;
	}
   ...
   jQuery(function(){
		jQuery('#mydatagrid').datagrid({
				...
				columns:[[
					...
					{title:'重量', field:'quantity', width:100, align:'right', sortable:true},
	...
	function showToday(){
	   ...
	   //alert(avgQuantity);
       var link = "${contextPath}/heathcare/goodsActualQuantity/reviewJson?tenantId=${tenantId}&showToday=true&avgQuantity=on";
	   loadGridData(link);
	}
      ...
      <table valign="top">
       <tr valign="top">
	    <td valign="top" width="42%">   
			...
			&nbsp;<span class="x_content_title">人均进食量列表</span>
		</td>
		<td valign="top" style="font-size:13px; line-height:20px;">
		  &nbsp;开始&nbsp;
		  <input id="startTime" name="startTime" type="text" class="easyui-datebox x-text" style="height:28px; width:120px"
		         <#if startTime?exists> value="${startTime}"</#if>>
		  &nbsp;结束&nbsp;
		  <input id="endTime" name="endTime" type="text" class="easyui-datebox x-text" style="height:28px; width:120px"
