...
<script type="text/javascript">
	...
	function exportXls(reportId){
		if(verifyForm()){
            ...
            var link = '${contextPath}/heathcare/reportMain/exportXls?ts=${ts}&date='+date+'&reportId='+reportId;
		    window.open(link);	
		}
	}
	...
	function doWeeklyExport12(){
		...
		var link="${contextPath}/heathcare/reportJxls2/exportXls?ts=${ts}&reportId=WeeklyFoodActualQuantityCount";
		if(startTime != ""){
	...
	function doWeeklyExport1(){
		...
		var link="${contextPath}/heathcare/reportMain/exportXls?ts=${ts}&reportId=WeekMultiSheetGoodsActualQuantity";
		if(startTime != ""){
			link = link + "&startDate=" + startTime ;
		}
		if(endTime != ""){
	...
	function doWeeklyExport2(){
		...
		var link="${contextPath}/heathcare/reportMain/exportXls?ts=${ts}&reportId=WeekMultiAreaGoodsActualQuantity";
		if(startTime != ""){
			link = link + "&startDate=" + startTime ;
		}
		if(endTime != ""){
	...
	function doWeeklyExport3(){
		...
		var link="${contextPath}/heathcare/reportMain/exportXls?ts=${ts}&reportId=WeekGoodsActualQuantity";
		if(startTime != ""){
			link = link + "&startDate=" + startTime ;
		}
		if(endTime != ""){
	...
	function doWeeklyExport5(){
		...
		var link="${contextPath}/heathcare/reportMain/exportXls?ts=${ts}&reportId=WeeklyMultiAreaFoodActualQuantity";
		if(startTime != ""){
			link = link + "&startDate=" + startTime ;
		}
		if(endTime != ""){
    ...
    function doWeeklyExport5x(){
		...
		var link="${contextPath}/heathcare/reportMain/exportXls?ts=${ts}&reportId=WeeklyMultiSheetFoodActualQuantity";
		if(startTime != ""){
			link = link + "&startDate=" + startTime ;
		}
		if(endTime != ""){
	...
	function doWeeklyExport6(){
		...
		var link="${contextPath}/heathcare/reportMain/exportXls?ts=${ts}&reportId=WeeklyFoodActualQuantity";
		if(startTime != ""){
			link = link + "&startDate=" + startTime ;
		}
		if(endTime != ""){
	...
	function doWeeklyExport8(){
		...
		var link="${contextPath}/heathcare/reportMain/exportXls?ts=${ts}&reportId=WeeklyFoodNutritionCount";
		if(startTime != ""){
			link = link + "&startDate=" + startTime;
		}
		if(endTime != ""){
	...
	function doWeeklyExport9(){
		...
		var link="${contextPath}/heathcare/reportMain/exportXls?ts=${ts}&reportId=DietaryMultiAreaNutritionCount";
		if(startTime != ""){
			link = link + "&startDate=" + startTime;
		}
		if(endTime != ""){
	...
	function doDietaryAnalyzeExport12(){
		...
		var link="${contextPath}/heathcare/reportMain/exportXls?ts=${ts}&reportId=DietaryAnalyze";
		if(startTime != ""){
			link = link + "&startDate=" + startTime;
		}
		if(endTime != ""){
	...
	function showDayExport(){
        if(verifyForm()){
		    var date = document.getElementById("date").value;
            var link = '${contextPath}/heathcare/goodsActualQuantity/showDayExport?ts=${ts}&date='+date;
		    window.open(link);	
		}
	}
	...
	function showSectionExport(){
        ...
        var link = '${contextPath}/heathcare/goodsActualQuantity/showSectionExport?ts=${ts}&q=1';
		if(startTime != ""){
			link = link + "&startDate=" + startTime;
		}
		if(endTime != ""){
	...
	function doExport99(){
		...
		var link="${contextPath}/heathcare/tenantReportMain/exportXls?ts=${ts}&reportId=TenantDietaryStructAnalyze";
		if(startTime != ""){
			link = link + "&startDate=" + startTime;
		}
		if(endTime != ""){
