   ...
   jQuery(function(){
		jQuery('#mydatagrid').datagrid({
				...
				columns:[[
					...
					{title:'电话',field:'telephone', width:120, sortable:true},
	...
	function formatterKeys(val, row){
		...
		str = str+"&nbsp;<a href='javascript:persionlist(\""+row.id+"\");'>儿童</a>&nbsp;<a href='javascript:persionlist2(\""+row.id+"\");'>在册儿童</a>&nbsp;<a href='javascript:showImp(\""+row.id+"\");'>导入</a>";
	    return str;
	}
	...
	function showImp(gradeId){
	    var link="${contextPath}/heathcare/person/showImport?gradeId="+gradeId;
		jQuery.layer({
			type: 2,
			maxmin: true,
			shadeClose: true,
	...
	function persionlist2(id){
	    var link = '${contextPath}/heathcare/gradePersonRelation?gradeId='+id;
	    jQuery.layer({
			type: 2,
			maxmin: true,
			shadeClose: true,
