   ...
   jQuery(function(){
		jQuery('#mydatagrid').datagrid({
				...
				columns:[[
					...
					{title:'负责人',field:'principal', width:120, sortable:true},
	...
	function formatterKeys(val, row){
		var str = "";
		str = str+"<a href='javascript:inspectionList2(\""+row.id+"\");'>巡视检查</a>";
	...
	function persionlist(id){
	    var link = '${contextPath}/heathcare/person/list2?gradeId='+id;
	    //location.href=link;
		jQuery.layer({
			type: 2,
			maxmin: true,
	...
	function absenceList2(gradeId){
		var link='${contextPath}/heathcare/personAbsence?gradeId='+gradeId;
		jQuery.layer({
				type: 2,
				maxmin: true,
				shadeClose: true,
	...
	function inspectionList(){
		...
		var selected = jQuery('#mydatagrid').datagrid('getSelected');
		if (selected ){
		    var link='${contextPath}/heathcare/personInspection?inspectionFlag=${inspectionFlag}&type=${type}&gradeId='+selected.id;
			//location.href=link;		
		    jQuery.layer({
				type: 2,
				maxmin: true,
	...
	function inspectionList2(gradeId){
		var link='${contextPath}/heathcare/personInspection?inspectionFlag=${inspectionFlag}&type=${type}&gradeId='+gradeId;
	    //location.href=link;
		jQuery.layer({
				type: 2,
				maxmin: true,
...
<div class="easyui-layout" data-options="fit:true">  
   <div data-options="region:'north', split:false, border:true" style="height:48px; margin-top:5px;" class="toolbar-backgroud"> 
