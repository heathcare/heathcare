...
<script type="text/javascript">
	...
	function showExport(){
		...
		var link="${contextPath}/heathcare/tenantReportMain/exportXls?tenantId=${tenantId}&ts=${ts}&reportId=TenantDietaryStructAnalyze&outputFormat=html";
		if(startTime != ""){
...
<body style="margin-left:5px;overflow:hidden;" onload="javascript:initDate();">
