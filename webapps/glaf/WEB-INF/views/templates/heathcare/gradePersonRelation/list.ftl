...
<script language="javascript">
	...
	function saveData() {
		...
		jQuery.ajax({
				   type: "POST",
				   url: '${contextPath}/heathcare/gradePersonRelation/saveAll?gradeId=${gradeId}',
				   data: params,
				   dataType: 'json',
				   error: function(data){
					   alert('服务器处理错误！');
...
<center> <br>
<form id="iForm" name="iForm" class="x-form" action="${contextPath}/heathcare/gradePersonRelation?gradeId=${gradeId}">
<input type="hidden" id="items" name="items"> 
<input type="hidden" id="gradeId" name="gradeId" value="${gradeId}"> 
<div class="content-block" style="width: 785px;"> 
<div class="x_content_title">
  <img src="${contextPath}/static/images/window.png" alt="${gradeInfo.name}在册儿童设置">
      &nbsp;${gradeInfo.name}在册儿童设置
</div>
<table class="table-border" align="center" cellpadding="4" cellspacing="1" width="90%">
 <tr>
	<td width="20%">&nbsp;</td>
	<td width="30%">
	  请选择年份&nbsp;<select id="year" name="year" onchange="javascript:switchXY();">
	...
	<td width="30%">
	  请选择月份&nbsp;<select id="month" name="month" onchange="javascript:switchXY();">
					<option value="0">----请选择----</option>
	 ...
	 <tbody>		 
		<tr>
			<td colspan="2" width="212">
			 <div align="center">
			   <div align="center">可选儿童</div>
			 </div>
			</td>
			<td></td>
			<td colspan="2" width="212">
			  <div align="center">已选儿童</div>
			</td>
		</tr>
		<tr>
			<td width="2">&nbsp;</td>
			...
			<div align="center">
			    <select class="list" id="noselected" name="noselected" 
				        style="width:200px; height:450px;" multiple="multiple" size="12"
