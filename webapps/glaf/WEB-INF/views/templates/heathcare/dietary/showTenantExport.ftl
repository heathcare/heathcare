...
.table-border { background-color:#3399cc;  font-family:"微软雅黑"}
.table-content { background-color:#ffffff; font-size: 16px; font-family:"微软雅黑"}
...
<script type="text/javascript">
	...
	function exportWeek(){
		...
		window.open('${contextPath}/heathcare/dietaryExport/exportTenantWeek?tenantId=${tenantId}&exportType=xls&year='+year+'&week='+week); 
	}
	...
	function doSubmit(){
 	...
 	function exportNutrition(){
		...
		var link="${contextPath}/heathcare/tenantReportMain/exportXls?tenantId=${tenantId}&reportId=TenantWeeklyDietaryNutritionCount";
		if(year != ""){
			link = link + "&year=" + year;
		}
		if(week != ""){
	   ...
	   <table width="100%" align="left">
		<tbody>
		 <tr>
			...
			<img src="${contextPath}/static/images/window.png"><span class="x_content_title">一周食谱</span>
			</td>
			<td width="45%" align="left">
			  ...
			  &nbsp;周次&nbsp;
			  <select id="week" name="week" onchange="javascript:doSubmit();">
				<#list weeks as week>
		  ...
		  <td width="18%" class="table-content">
			  ...
			  <tr>
				<td valign="top" width="40%">
				    <span class="dietary_title" >${r1.name}</span>
				</td>
 ...
 <script type="text/javascript">
  <#if week?exists>
	jQuery(document).ready(function() { 
        ...
        $('#x1').attr('src', '${contextPath}/chart/highcharts/showChart?chartId=235903&type=heatEnergyX1PerDayDietaryOfWeekTenant&week=${week}&year=${year}&semester=${semester}&tenantId=${tenantId}&sysFlag=N');

		$('#x2').attr('src', '${contextPath}/chart/highcharts/showChart?chartId=235902&type=heatEnergyX2PerDayDietaryOfWeekTenant&week=${week}&year=${year}&semester=${semester}&tenantId=${tenantId}&sysFlag=N');

		$('#x3').attr('src', '${contextPath}/chart/highcharts/showChart?chartId=235907&type=heatEnergyX3PercentPerDayDietaryOfWeekTenant&week=${week}&year=${year}&semester=${semester}&tenantId=${tenantId}&sysFlag=N');

		$('#x4').attr('src', '${contextPath}/chart/highcharts/showChart?chartId=235302&type=proteinPercentPerDayDietaryOfWeekTenant&week=${week}&year=${year}&semester=${semester}&tenantId=${tenantId}&sysFlag=N');

		$('#x5').attr('src', '${contextPath}/chart/highcharts/showChart?chartId=235904&type=vitaminAAnimalsX3PercentPerDayDietaryOfWeekTenant&week=${week}&year=${year}&semester=${semester}&tenantId=${tenantId}&sysFlag=N');

		$('#x6').attr('src', '${contextPath}/chart/highcharts/showChart?chartId=235905&type=ironAnimalsX3PercentPerDayDietaryOfWeekTenant&week=${week}&year=${year}&semester=${semester}&tenantId=${tenantId}&sysFlag=N');

		$('#x7').attr('src', '${contextPath}/chart/highcharts/showChart?chartId=235906&type=fatAnimalsX3PercentPerDayDietaryOfWeekTenant&week=${week}&year=${year}&semester=${semester}&tenantId=${tenantId}&sysFlag=N');

		$('#x8').attr('src', '${contextPath}/chart/highcharts/showChart?chartId=235908&type=calciumPhosphorusX3PercentOfWeekTenant&week=${week}&year=${year}&semester=${semester}&tenantId=${tenantId}&sysFlag=N');
