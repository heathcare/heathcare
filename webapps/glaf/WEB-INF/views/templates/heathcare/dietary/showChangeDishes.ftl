...
<script type="text/javascript">
	...
	function changeDishes(){
        ...
        if(confirm("确定要用选中的菜肴【"+jQuery("#dishesName").val()+"】替换【${dietary.name}】吗？")){
			var dishesId = jQuery("#dishesId").val();
            var link = "${contextPath}/heathcare/dietary/changeDishes?oDietaryId=${dietary.id}&dishesId="+dishesId;
