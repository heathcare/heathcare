...
<script type="text/javascript">
	...
	function addDishes(){
        ...
        if(confirm("确定要增加选中的菜肴【"+jQuery("#dishesName").val()+"】吗？")){
			var dishesId = jQuery("#dishesId").val();
            var link = "${contextPath}/heathcare/dietary/addDishes?oDietaryId=${dietary.id}&dishesId="+dishesId;
...
<div class="easyui-layout" data-options="fit:true">  
   <div data-options="region:'north',split:false, border:true" style="height:68px" class="toolbar-backgroud"> 
	...
	<form id="iForm" name="iForm" method="post" action="">
	  ...
	  <input type="hidden" id="oDietaryId" name="oDietaryId" value="${oDietaryId}">
		 ...
		 <tr>
			...
			<td width="65%" align="left">
              ...
              <a href="#" class="easyui-linkbutton" data-options="plain:true, iconCls:'icon-ok'" 
	             onclick="javascript:addDishes();" >确定</a>
			  </#if>
			</td>
		</tr>
		<tr>
