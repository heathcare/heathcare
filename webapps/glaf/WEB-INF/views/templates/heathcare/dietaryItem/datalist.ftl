...
<script type="text/javascript">
   ...
   function updateDietaryName(){
		var form = document.getElementById("iForm");
	    var link = "${contextPath}/heathcare/dietary/updateDietaryName";
	 ...
	 <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
       <tr>
        ...
        <td width="50%">
			...
			<input type="hidden" id="dietaryId" name="dietaryId" value="${dietary.id}">
			<input type="text" id="dietaryName" name="dietaryName" value="${dietary.name}" class="x-small-text" 
			       style="width:250px">
			&nbsp;
			<input type="button" value="食谱改名" onclick="javascript:updateDietaryName();" class="btnGrayMini">
			</form>
			</#if>
		</td>
	   </tr>
