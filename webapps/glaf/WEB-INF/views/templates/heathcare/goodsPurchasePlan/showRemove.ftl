...
<script type="text/javascript">
	...
	function deleteWeekData(){
        ...
        if(confirm("数据删除后不能恢复，确定删除数据吗？")){
		  ...
		  jQuery.ajax({
				   type: "POST",
				   url: '${contextPath}/heathcare/goodsPurchasePlan/removeWeekPlan',
				   data: params,
				   dataType: 'json',
				   error: function(data){
					   alert('服务器处理错误！');
    ...
    function deleteDayData(){
        ...
        if(confirm("数据删除后不能恢复，确定删除数据吗？")){
		  ...
		  jQuery.ajax({
				   type: "POST",
				   url: '${contextPath}/heathcare/goodsPurchasePlan/removeDayPlan',
				   data: params,
				   dataType: 'json',
				   error: function(data){
					   alert('服务器处理错误！');
  ...
  <tr>
	<td>
	  <table class="easyui-form" style="width:250px;" align="top">
		<tbody>
		<tr>
		   <td width="100%" colspan="2" align="left"><span class="x_content_title">&nbsp;&nbsp;删除一周采购计划数据</span></td>
		</tr>
		<tr>
	...
	<td>
	  <table class="easyui-form" style="width:300px;" align="center" valign="top">
		<tbody>
		<tr>
		   <td width="100%" colspan="2" align="left"><span class="x_content_title">删除一天采购计划数据</span></td>
		</tr>
		<tr>
