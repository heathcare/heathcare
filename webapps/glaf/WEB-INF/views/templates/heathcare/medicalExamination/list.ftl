    ...
    jQuery(function(){
		jQuery('#mydatagrid').datagrid({
				...
				columns:[[
						...
						{title:'年龄别身高', field:'heightEvaluateHtml', width:120, align:"center", sortable:true},
						{title:'体重(千克)', field:'weight', width:90, align:"right", sortable:true},
						{title:'年龄别体重', field:'weightEvaluateHtml', width:120, align:"center", sortable:true},
						{title:'身高别体重', field:'weightHeightEvaluateHtml', width:120, align:"center", sortable:true},
