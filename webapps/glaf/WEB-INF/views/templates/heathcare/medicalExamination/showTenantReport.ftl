...
<script type="text/javascript">
    ...
    function exportXls(){
		var link="${contextPath}/heathcare/tenantReportMain/exportXls?reportId=TenantMedicalExaminationSicknessPositiveSign&tenantId=${tenantId}&checkId=${checkId}";
        window.open(link);
    }


	function exportXls2(){
		var link="${contextPath}/heathcare/tenantReportMain/exportXls?reportId=TenantMedicalExaminationCount&tenantId=${tenantId}&checkId=${checkId}";
        window.open(link);
    }
