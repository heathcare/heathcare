...
<script type="text/javascript">
	...
	function getFontCss(treeId, treeNode) {
	    return (!!treeNode.highlight) ? {color:"#0033ff", "font-weight":"bold"} : {color:"#333", "font-weight":"normal"};
    }
	...
	function searchNodes(){  
		...
		changeColor("myTree", "name", keywords); 
	}  
	...
	function changeColor(id, key, value) {
		...
		if (value != "") {
			...
			if (nodeList && nodeList.length > 0) {
				updateNodes(true, treeId, nodeList);
			}
		}
	}


	function updateNodes(highlight, treeId, nodeList) {
		var treeObj = $.fn.zTree.getZTreeObj(treeId);
    ...
    jQuery(function(){
		jQuery('#mydatagrid').datagrid({
				...
				columns:[[
						...
						{title:'身高评价', field:'heightEvaluateHtml', width:110, align:"center", sortable:true},
	...
	function addNew(){
	    ...
	    var link="${contextPath}/heathcare/medicalExamination/enterEdit?personId="+personId+"&checkId=${checkId}&type=${type}";
		layer.open({
		  type: 2,
          maxmin: true,
		  shadeClose: true,
	...
	function onMyRowClick(rowIndex, row){
	    var link = '${contextPath}/heathcare/medicalExamination/enterEdit?id='+row.id;
		layer.open({
		  type: 2,
          maxmin: true,
		  shadeClose: true,
    ...
    function editRow(id){
	    var link = '${contextPath}/heathcare/medicalExamination/enterEdit?id='+id;
		layer.open({
		  type: 2,
          maxmin: true,
		  shadeClose: true,
	...
	function editSelected(){
	    ...
	    if (selected ){
		  var link = '${contextPath}/heathcare/medicalExamination/enterEdit?id='+selected.id;
		  layer.open({
			  type: 2,
			  maxmin: true,
			  shadeClose: true,
	  ...
	  <div class="easyui-layout" data-options="fit:true"> 
	      <div data-options="region:'north', border:false" class="search-bar" style="margin:2px;height:30px">  
            <input id="keyword" name="keyword" type="text" placeholder="请输入..." class="x-small-text" style="width:100px;"
			       onkeyup="javascript:changeColor('myTree', 'name', this.value);"> 
