...
<script type="text/javascript">
    ...
    function exportXls(){
		window.open("${contextPath}/heathcare/tenantReportMain/exportXls?reportId=MedicalExamination1&examId=${medicalExamination.id}");
	}
    ...
    <tbody>
		...
		<tr>
		  ...
		  <td width="40%" align="left" class="table-content" colspan="4">
		      &nbsp;&nbsp;<input id="hemoglobinValue" name="hemoglobinValue" type="text" precision="1"
		  ...
		  <td width="10%" align="center" class="table-content">谷丙转氨酶ALT</td>
		  <td width="40%" align="left" class="table-content" colspan="4">
              &nbsp;&nbsp;<input id="altValue" name="altValue" type="text" precision="1"
							     class="easyui-numberbox x-small-text" style="width:60px"
							     value="${medicalExamination.altValue}"/>（U/L）&nbsp;${medicalExamination.altHtml}
		  </td>
		</tr>
