...
<script type="text/javascript" src="${contextPath}/static/plugins/easyui/jquery.easyui.min.js"></script>
<script type="text/javascript" src="${contextPath}/static/plugins/easyui/locale/easyui-lang-zh_CN.js"></script>
