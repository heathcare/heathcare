...
<div class="easyui-layout" data-options="fit:true">  
  ...
  <table class="easyui-form" style="width:800px;" align="center">
	...
	<tr>
		<td width="20%" align="left">厂商&nbsp;</td>
		<td align="left">
			<select id="provider" name="provider" nullable="no" >
              <option value="">----请选择----</option>
				<option value="aliyun">阿里云</option>
				<option value="custom">其他</option>
			</select>
			<script type="text/javascript">
			    document.getElementById("provider").value="${smsServer.provider}";
			</script>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td width="20%" align="left">访问Key</td>
		<td align="left">
            <input id="accessKeyId" name="accessKeyId" type="text" 
			       class="easyui-validatebox  x-text" style=" width:385px;"
				   value="${smsServer.accessKeyId}"/>
		</td>
	</tr>
	<tr>
		<td width="20%" align="left">访问密锁</td>
		<td align="left">
            <input id="accessKeySecret" name="accessKeySecret" type="text" 
			       class="easyui-validatebox  x-text" style=" width:385px;"
				   value="${smsServer.accessKeySecret}"/>
		</td>
	</tr>
	<tr>
		<td width="20%" align="left">签名</td>
		<td align="left">
            <input id="signName" name="signName" type="text" 
			       class="easyui-validatebox  x-text" style=" width:385px;"
				   value="${smsServer.signName}"/>
		</td>
	</tr>
	<tr>
		<td width="20%" align="left">模板代码</td>
		<td align="left">
            <input id="templateCode" name="templateCode" type="text" 
			       class="easyui-validatebox  x-text" style=" width:385px;"
				   value="${smsServer.templateCode}"/>
		</td>
	</tr>
	<tr>
