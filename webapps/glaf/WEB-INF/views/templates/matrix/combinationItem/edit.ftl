...
<script type="text/javascript">
	...
	function saveData(){
		...
		jQuery.ajax({
				   type: "POST",
				   url: '${request.contextPath}/sys/combinationItem/save',
				   data: params,
				   dataType: 'json',
				   error: function(data){
					   alert('服务器处理错误！');
...
<div class="easyui-layout" data-options="fit:true">  
  <div data-options="region:'north', split:false, border:true" style="height:42px" class="toolbar-backgroud"> 
	...
	<span class="x_content_title">&nbsp;<img src="${request.contextPath}/static/images/window.png">&nbsp;编辑组合项</span>
  ...
  <input type="hidden" id="id" name="id" value="${combinationItem.id}"/>
	...
	<tr>
		...
		<td align="left">
            <input id="recursionColumns" name="recursionColumns" type="text" 
			       class="easyui-validatebox x-text" style="width:525px;"  
				   value="${combinationItem.recursionColumns}"/>
	...
	<tr>
		...
		<td align="left">
            <input id="primaryKey" name="primaryKey" type="text" 
			       class="easyui-validatebox x-text" style="width:525px;"  
				   value="${combinationItem.primaryKey}"/>
    ...
    <tr>
		...
		<td align="left">
		    <select id="sortNo" name="sortNo">
             ...
             <script type="text/javascript">
                 document.getElementById("sortNo").value="${combinationItem.sortNo}";
             </script>
			 &nbsp;（提示：顺序小的先执行。）
		</td>
	  </tr>
	  ...
	  <tr>
		...
		<td align="left">
		    <select id="locked" name="locked">
             ...
             <script type="text/javascript">
                 document.getElementById("locked").value="${combinationItem.locked}";
             </script>
		</td>
	</tr>
	<tr>
