	...
	<tr>
		...
		<td align="left">
		    <textarea id="recursionSql" name="recursionSql" rows="4" cols="46" class="x-textarea" 
			          style="font:13px Consolas,Courier New,Arial; width:525px; height:90px;" >${dataExportItem.recursionSql}</textarea>
	...
	<tr>
		...
		<td align="left">
		    <textarea id="sql" name="sql" rows="6" cols="46" class="x-textarea" 
			    style="font:13px Consolas,Courier New,Arial; width:525px; height:320px;" >${dataExportItem.sql}</textarea>
		   <div style="margin-top:5px;">
		     （提示：可以使用union语句组合结果。）
			<br>
			<span>
