...
<script type="text/javascript">
	...
	function saveData(){
		if(document.iForm.locked.value == "1"){
			if(confirm("客户锁定后该客户用户将无法登录系统，确定吗？")){
             var params = jQuery("#iForm").formSerialize();
		     jQuery.ajax({
				   type: "POST",
				   url: '${contextPath}/mgmr/tenant/saveTenant',
				   data: params,
				   dataType: 'json',
				   error: function(data){
					   alert('服务器处理错误！');
...
<div class="easyui-layout" data-options="fit:true">  
  <div data-options="region:'north',split:false,border:true" style="height:42px" class="toolbar-backgroud"> 
	...
	<span class="x_content_title">&nbsp;<img src="${contextPath}/static/images/window.png">&nbsp;编辑客户信息</span>
